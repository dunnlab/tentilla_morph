...
Most tentilla bear a pair of elastic strands (Totton cite) derived from the wall of the gastrovascular cavity.
...
for(prey in 1:ncol(diet)){
  ...
  if(length(unique(food))>1){
    pgls.SEy(food~regimes,data=data.frame(food,regimes), tree=dprunedTree, se= rep(0, length(food)))
  }}
