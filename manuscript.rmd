...
Speciemns from the Monterey Bay and Gulf of California were collected by remotely operated underwater vehicles (ROV) or by blue-water SCUBA divers, following the protocols established in [@haddock2005scientific].
...
grid.newpage()
grid.table(morphdata, base_size=6)
```
