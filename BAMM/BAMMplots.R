...
pdf("BAMM_desmoneme_elongation_css.pdf", width=7, height=10)
...
pdf("BAMM_desmoneme_elongation_netdiv.pdf", width=7, height=5)
...
pdf("desmoneme_elongation_ratesplot.pdf",width=16,height=16)
