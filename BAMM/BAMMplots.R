...
pdf("BAMM_heteroneme_elongation_css.pdf", width=7, height=10)
...
pdf("BAMM_heteroneme_elongation_netdiv.pdf", width=7, height=5)
...
pdf("heteroneme_elongation_ratesplot.pdf",width=16,height=16)
