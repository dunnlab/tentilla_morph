...
#read.tree("gene_ct.trees") %>% consensus() -> daconsensus
#plot(daconsensus)
consensus = read.nexus("TimeTreeCT.tre") %>% drop.tip(53:58)
...
#ultra_consensus = chronos(consensus,100)
...
hypdiet = c("Mixed", "Mixed", "Crustacean", "Copepod", "Mixed",  "Fish", "Fish", "Ostracod", "Copepod", "Copepod", "Mixed", "Crustacean")
...
for(c in 2:ncol(dprunedmatrix_logs)){  #1:ncol(sharedmeans)
  ...
  Cdata = data.frame(dprunedmatrix$Species,hypdiet,dprunedmatrix[,c])
